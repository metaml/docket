...
dev: init ghc-chain # sandbox
ghc-chain: ghc cabal cabal-install
...
init:
	apt-get update -y
	apt-get install -y libgmp-dev zlib1g-dev libncurses5-dev gcc g++ python-pygments wget \
			   ghc happy alex haddock cabal-install 
